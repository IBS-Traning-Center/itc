...
<head>
    ...
    <link href="/school/css/all.css?check=45" rel="stylesheet" type="text/css">
    <link href="/school/css/form.css?check=46" rel="stylesheet" type="text/css">
...
<body>
        <?$elementID=$APPLICATION->IncludeComponent("bitrix:news.detail", "landing-school", array(
	"IBLOCK_TYPE" => "ig_land",
	"IBLOCK_ID" => "162",
	"ELEMENT_ID" => "",
