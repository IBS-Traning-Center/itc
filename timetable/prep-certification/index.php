...
<section id="content" class="not-main-page">
    <div class="container">
        ...
        $courses = [];
        $arFilter = Array("IBLOCK_ID"=>6, "ACTIVE"=>"Y", "PROPERTY_preparation_certification"=>447);
        $res = CIBlockElement::GetList(Array(), $arFilter, false, false, Array("CODE"));
        while ($course = $res->GetNext()) {
            $courses[] = $course["CODE"];
        }
        $GLOBALS["arrFilter"] = array("ACTIVE" => "Y", "PROPERTY_course_code" => $courses, ">PROPERTY_startdate" => $data);
