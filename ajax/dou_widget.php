...
<?GLOBAL $arrFilter;
$arrFilter["!NAME"]=array("%рекрут%", "%Управление конфликтами%", "%Искусство продаж%", "%Успешная коммуникация%");
$arrFilter["PROPERTY_CITY"]=array(5745, 5747, 5746, 14909);
$arrFilter[">PROPERTY_startdate"]=date("Y-m-d", strtotime("+21 day"));
$arrFilter["<PROPERTY_startdate"]=date("Y-m-d", strtotime("+91 day"));
$APPLICATION->IncludeComponent("bitrix:news.list", "widget-dou", Array(
