...
<?$APPLICATION->IncludeComponent("bitrix:catalog", "edu_schools_online", array(
	...
	"LIST_META_KEYWORDS" => "UF_META_KEY",
	"LIST_META_DESCRIPTION" => "UF_META_DESC",
