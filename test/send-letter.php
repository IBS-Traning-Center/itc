								...
								<div class='l_course' style=''>
									...
									<table border=0 cellpading=0 cellspacing=0 style='width: 100%;'>
										<tr>
											...
											<td class='pad_null' style='height: 32px;  padding: 0; background: #22427c; text-align: center;'><a target='_blank' style='color:#fff;text-decoration:none; font-weight:bold;font-size:14px; font-family: Arial;' href='http://ibs-training.ru/internal/catalog/".$arInfo['COURSE_CODE']."/'>ПОДРОБОНЕЕ</a></td>
