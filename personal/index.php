...
<style>
    ...
    .course-card.featured .date-text,
    .course-card.featured .time-text {
        color: #FFFFFF;
    }
    .course-card:not(.featured) .date-text,
    .course-card:not(.featured) .time-text {
        color: #000000;
    }
    ...
    .course-card:not(.featured) .course-description {
        color: #000000;
    }
    .trainer-avatar.gradient .ellipse-11 {
        background: linear-gradient(90deg, #2F6298 0%, #438DB0 100%);
    }
    .trainer-avatar:not(.gradient) .ellipse-11 {
        background: #FFFFFF;
    }
    .course-card.featured .trainer-name {
        color: #FFFFFF;
    }
    .course-card.featured .current-price {
        color: #FFFFFF;
    }
    .course-card.featured .rectangle-21 {
        border-color: #FFFFFF;
    }
    .course-card:not(.featured) .rectangle-21 {
        border-color: #000000;
    }
    .course-card.featured .line-16 {
        border-color: #FFFFFF;
    }
    .course-card:not(.featured) .line-16 {
        border-color: #000000;
    }
    .course-card.featured .ellipse-2 {
        border-color: #FFFFFF;
    }

    .course-card:not(.featured) .ellipse-2 {
        border-color: #000000;
    }
