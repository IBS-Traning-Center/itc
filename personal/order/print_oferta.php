...
if (CModule::IncludeModule("sale"))
{
	...
	if ($arOrder = CSaleOrder::GetByID($ORDER_ID))
	{
		...
		global $USER;
		$vCurrrentUserID = $USER->GetID();
		if (($vCurrrentUserID == $arOrder["USER_ID"]) and ($_REQUEST["doc"] == "invoice_oferta")) {
			include($rep_file_name);
		}else {
			ShowError("ACCESS_DENIED");
		}
	}
	//require_once($_SERVER["DOCUMENT_ROOT"]."/bitrix/admin/reports/invoice_oferta.php");
}
else
