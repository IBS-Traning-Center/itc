                ...
                <table border="0" cellspacing="0" cellpadding="0" align="center" style="width: 100%; max-width: 600px;">
                    <tr>
                        <td valign="top" align="center">
                            <img src="/images_new/weekly_images/w-header.png" width="600" alt="Luxoft Alumni Logo">
                        </td>
                    </tr>
                </table>
            </td>
                    ...
                    <tr>
                        <td align="left" valign="top" style="font-family: arial; color: #333333; font-size: 13px; line-height:19px; background-color: #ffffff;" bgcolor="#ffffff">
                            <div style="font-family: arial; color: #333333; font-size: 13px; line-height:19px; background-color: #ffffff;">
                                <span style="color:#e25a10; font-weight: bold; font-family: arial; font-size: 18px; line-height:26px;">Keep updated, read the main <b>Luxoft news!</b> Global company news for this month:</span>
                                <br>
                                <br>
 <?
        ...
        <tr>
            <td bgcolor="#ffffff" style="" height="57" valign="top">
                <table border="0" cellspacing="0" cellpadding="0" align="center" style="width: 100%; max-width: 600px;">
                    <tr>
                        <td valign="top" align="center">
                            <img src="/images_new/weekly_images/w-stripe-luxoft-vacancies.png" width="600" alt="Luxoft vacancies">
                        </td>
                    </tr>
                </table>
            </td>
                ...
                <table border="0" cellspacing="0" cellpadding="0" style="padding-right: 15px; padding-left: 20px">
                    ...
                    <tr>
                        <td align="left" valign="top" style="font-family: arial; color: #333333; font-size: 13px; line-height:19px; background-color: #ffffff;" bgcolor="#ffffff">
                            <div style="">
                            <div style="font-family: arial; color: #333333; font-size: 13px; line-height:19px; background-color: #ffffff;">
                                <span style="color:#e25a10; font-weight: bold; font-family: arial; font-size: 18px; line-height:26px;">We are constantly growing - <b>grow with us!</b> Some hot vacancies available today:</span>
                                <br>
                                <?
...
*/?>
        ...
        <tr>
            <td bgcolor="#ffffff" style="" height="57" valign="top">
                <table border="0" cellspacing="0" cellpadding="0" align="center" style="width: 100%; max-width: 600px;">
                    <tr>
                        <td valign="top" align="center">
                            <img src="/images_new/weekly_images/w-stripe-global-career-vacancies.png" width="600" alt="Global Career Vacancies">
                        </td>
                    </tr>
                </table>
            </td>
            ...
            <td style="background-color: #ffffff;">
                <table border="0" cellspacing="0" cellpadding="0" style="padding-right: 15px; padding-left: 20px">
                    ...
                    <tr>
                        <td align="left" valign="top" style="font-family: arial; color: #333333; font-size: 13px; line-height:19px; background-color: #ffffff;" bgcolor="#ffffff">
                            <div style="font-family: arial; color: #333333; font-size: 13px; line-height:19px; background-color: #ffffff;">
                                <span style="color:#e25a10; font-weight: bold; font-family: arial; font-size: 18px; line-height:26px;">GlobalCareer recruitment agency helps to develop an international career in one click!</span>
                                <br>
                                <p>
                                    Help your friends in getting their dream jobs, and you can receive a reward for it!
                                </p>
                                <p>
                                ...
                                <p>
                                    Presently, our clients have a wide variety of<strong> vacant roles</strong>, and you can recommend candidates (your friends or ex-colleagues) for them. The complete list of the positions is posted at our website, use the links:
                                </p>
                                <ul>
                                    <li><a style="text-decoration: none; color:#033b7a; font-weight:bold;" href="http://www.globalcareer.eu/ru/candidates/">Russian Vacancies</a></li>
                                    <li><a style="text-decoration: none; color:#033b7a; font-weight:bold;" href="http://www.globalcareer.eu/candidates/">International Vacancies</a></li>
                                </ul>
                                <p>
                                    Please send your recommendations to our e-mail: <a style="text-decoration: none; color:#033b7a; font-weight:bold;" href="mailto:info@globalcareer.eu">info@globalcareer.eu</a> with the note <br/>«I recommend». We would be grateful for your information about relevant candidates!
                                </p>
                            </div>
                        </td>
                    </tr>
        ...
        <tr>
            <td bgcolor="#ffffff" style="" height="71" valign="top">
                <table border="0" cellspacing="0" cellpadding="0" align="center" style="width: 100%; max-width: 600px;">
                    <tr>
                        <td valign="top" align="center">
                            <img src="/images_new/weekly_images/w-stripe-referral-program.png" width="600" alt="Referral Program">
                        </td>
                    </tr>
                </table>
            </td>
            ...
            <td style="background-color: #ffffff;">
                <table border="0" cellspacing="0" cellpadding="0" style="padding-right: 15px; padding-left: 20px">
                    ...
                    <tr>
                        <td align="left" valign="top" style="font-family: arial; color: #333333; font-size: 13px; line-height:19px; background-color: #ffffff;" bgcolor="#ffffff">
                            <div style="font-family: arial; color: #333333; font-size: 13px; line-height:19px; background-color: #ffffff;">
                                <span style="color:#e25a10; font-weight: bold; font-family: arial; font-size: 18px; line-height:26px;">You can get an extra bonus!</span>
                                <br>
                                <p>
                                    <strong>Referral Program</strong> is an internal program of Recruitment Department, which enables it to attract specialists from the market for closing of existing and prospective vacancies in the company.
                                </p>
                                <p>
                                ...
                                <p>
                                    As soon as your IT friend <strong>passes our recruitment process and is hired</strong>, you recommendation becomes applicable for a bonus! You’ll get it <strong>in 3 months after your friend started working</strong>.
                                </p>
                                <p>
                                    The size of the bonus for a successful recommendation depends on the level of the closed vacancy
                                </p>
                            </div>
                        </td>
                    </tr>
        ...
        <tr>
            <td bgcolor="#ffffff" style="" height="70" valign="top">
                <table border="0" cellspacing="0" cellpadding="0" align="center" style="width: 100%; max-width: 600px;">
                    <tr>
                        <td valign="top" align="center">
                            <img src="/images_new/weekly_images/w-stripe-trainings.png" width="600" alt="Trainings">
                        </td>
                    </tr>
                </table>
            </td>
        ...
        ?>
                                ...
                                */ ?>
                                <div style="margin-top: 5px;padding-top: 3px;">
                                    <span style="color:#333333; font-weight: normal; font-family: arial; font-size: 13px; line-height:19px;">Find <b>more trainings</b> in different locations at <a style="text-decoration: none; color:#033b7a; font-weight:bold;" href="http://www.luxoft-training.com/">Luxoft Training!</a></span>
                                </div>
                            </div>
                        </td>
                    </tr>
        ...
        <tr>
            <td bgcolor="#ffffff" style="" height="87" valign="top">
                <table border="0" cellspacing="0" cellpadding="0" align="center" style="width: 100%; max-width: 600px;">
                    <tr>
                        <td valign="top" align="center">
                            <img src="/images_new/weekly_images/w-stripe-global-presence.png" width="600" alt="Global Presence">
                        </td>
                    </tr>
                </table>
            </td>
            ...
            <td style="background-color: #ffffff;">
                <table border="0" cellspacing="0" cellpadding="0" style="padding-right: 15px; padding-left: 20px">
                    ...
                    <tr>
                        <td align="left" valign="top" style="font-family: arial; color: #333333; font-size: 13px; line-height:19px; background-color: #ffffff;" bgcolor="#ffffff">
                            <div style="font-family: arial; color: #333333; font-size: 13px; line-height:19px; background-color: #ffffff;">
                                <span style="color:#e25a10; font-weight: bold; font-family: arial; font-size: 18px; line-height:26px;">Opportunities to work in an open world. Become a part of our global team!</span>
                                <br> <br>
                                <img src="/images_new/weekly_images/w-stripe-map.png" alt="Map" width="561">
                            </div>
                        </td>
                    </tr>
                </table>
            ...
            <td style="background-color: #ffffff;" valign="top">
                <table border="0" cellspacing="0" cellpadding="0" width="90%" style="padding-right: 15px; padding-left: 20px">
                    <tr>
						...
						<a style="text-decoration: none; color:#033b7a; font-size:17px; font-weight: bold;" href="mailto:didrisova<?=EMAIL_DOMAIN?>">Rukhlova Kseniya</a><br /><br />
Tel: + 495 967 8030 ext 5065<br>
												 Luxoft Global</span>
                            </div>
                        </td>
                    </tr>
                ...
                <br>
                <img src="/images_new/weekly_images/w-footer.png" width="600" height="62" alt="Alumni Footer" border="0">
            </td>
        </tr>
        <tr>
            <td height="30">
    ...
    <tr>
        <td align="center" valign="top" width="50%" class="templateColumnContainer">
            <table border="0" cellpadding="10" cellspacing="0" width="100%">
                <tr>
 <td style="padding-top: 0px; padding-right: 15px; padding-left: 20px; color: #333333; line-height:17px; font-size: 14px; font-family: 'Arial', serif;">
							...
							You are subscribed to receive this e-mail because you are a valued member of Luxoft's community and we would like to keep you updated<br>
							</span>
                                        <br/>
							<span style="color: #8A8A8A; font-family: 'Calibri', sans-serif; font-size: 12px; font-weight: normal; text-decoration:underline;">
							<a style="color: #8A8A8A;  text-decoration:underline;" href="http://www.luxoft-training.ru/unsubscribe/?mid=#MAIL_ID#&mhash=#MAIL_MD5#">Click here to unsubscribe from the mailing list</a> <br>
							</span>
                                        <br/>
        ...
        <td align="center" valign="top" width="50%" class="templateColumnContainer">
            <table border="0" cellpadding="10" cellspacing="0" width="100%">
                <tr>
<td valign="top" style="padding-top: 0px;line-height:21px; padding-left: 12px; color: #333333; font-size: 14px; font-family: 'Arial', serif;">
