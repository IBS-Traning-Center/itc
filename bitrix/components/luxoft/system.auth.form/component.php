...
$arResult["BACKURL"] = '/personal_test/learning/';
...
if(!$USER->IsAuthorized())
{
	...
	if(defined("AUTH_404"))
		...
		$arResult["AUTH_URL"] = $APPLICATION->GetCurPageParam("login=yes&modalform=yes", array_merge($arParamsToDelete, array("logout_butt", "backurl")));
