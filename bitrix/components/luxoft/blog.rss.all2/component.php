...
else
{
	...
	if ($textRSS = CBlog::BuildRSSAll($arParams["GROUP_ID"], $arResult["TYPE"], $arParams["MESSAGE_COUNT"], SITE_ID, false, false, array(), $arPathTemplates, $arParams["PARAM_GROUP_ID"], $arParams["USE_SOCNET"]))
	{
        ...
        echo preg_replace("#(<title>)(.+)(</title>)#","$1Блог Luxoft Training (программирование, тестирование, разработка ПО)$3", $textRSS, 1);
		//echo preg_replace("#(<link>|<title>)(.+)(</link>|</title>)#","$1$2?r1=ya&amp;r2=widget&amp;r3=blog$3", $textRSS);
        //echo $textRSS;
		if ($arParams["CACHE_TIME"] > 0)
