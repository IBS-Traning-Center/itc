...
$arComponentParameters = array(
	...
	"PARAMETERS" => array(
		...
		"PROPERTY_CODES_HIDDEN" => array(
			"PARENT" => "FIELDS",
			"NAME" => "Поля, которые недоступны для заполнения пользователю:",
			"TYPE" => "LIST",
			"MULTIPLE" => "Y",
			"ADDITIONAL_VALUES" => "N",
			"VALUES" => $arProperty_LNSF,
        ...
        "PROPERTY_TYPE_EVENT" => Array(
         "PARENT" => "FIELDS",
     	 "NAME" => "Тип события",
    	 "TYPE" => "LIST",
     	 "VALUES" => $arrEventType
  		),
        "PROPERTY_TEXT_TO_DO" => Array(
         "PARENT" => "FIELDS",
     	 "NAME" => "Надпись",
    	 "TYPE" => "TEXT",
		 "DEFAULT" => "Регистрация",
  		),
  		"PROPERTY_EVENT_NAME" => Array(
         "PARENT" => "FIELDS",
     	 "NAME" => "Название мероприятия (если точно известно)",
    	 "TYPE" => "TEXT",
		 "DEFAULT" => "",
  		),

  		"PROPERTY_EVENT_CITY_IN" => Array(
         "PARENT" => "FIELDS",
     	 "NAME" => "Город ивента (если точно известен)",
    	 "TYPE" => "TEXT",
		 "DEFAULT" => "",
  		),

  		"PROPERTY_EVENT_DATE_IN" => Array(
         "PARENT" => "FIELDS",
     	 "NAME" => "Дата (если точна известна)",
    	 "TYPE" => "TEXT",
		 "DEFAULT" => "",
  		),
