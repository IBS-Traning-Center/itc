...
<div class="cart-items" id="id-cart-list">
	...
	<table class="cart-items basket sale" cellspacing="0" cellpadding="0">
	<thead>
		<tr>
...
//  });
	...
	<div class="cart-ordering">
		<?if ($arParams["HIDE_COUPON"] != "Y"):?>
			<div class="cart-code">
				<input class="coupon" onclick="if (this.value=='<?=GetMessage("SALE_COUPON_VAL")?>')this.value=''" onblur="if (this.value=='')this.value='<?=GetMessage("SALE_COUPON_VAL")?>'" value="<?=GetMessage("SALE_COUPON_VAL")?>" name="COUPON" type="text">
			</div>
		<?endif;?>
		<div class="clear"></div><br />
		<div class="cart-oferta">
			<!--<input checked="checked" value="agree_oferta" id="agree_oferta" name="agree_oferta" type="checkbox"> <label for="agree_oferta" style="font-weight:normal;">Я принимаю условия <a href="/oferta_luxoft.doc">договора-оферты</a> по оказанию консультационных услуг Учебного Центра Luxoft</label>-->
		</div>
        <br />
