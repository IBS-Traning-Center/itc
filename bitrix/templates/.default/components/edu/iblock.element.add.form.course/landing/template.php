...
<?*/?>				
					...
					<br/>
					<br/>
					<input onclick="javascript: pageTracker._trackEvent('FILL_FORM','COURSE','<?=$_REQUEST['ID']?>');" type="submit" class="but main-test-button" name="iblock_submit_<?=$arParams['ANCHOR_PARAMETER']?>" value=" " />
