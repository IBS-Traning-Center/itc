...
<?}?>
 <form name="iblock_add_<?=$arParams['ANCHOR_PARAMETER']?>" action="<?=POST_FORM_ACTION_URI?>#<?=$arParams['ANCHOR_PARAMETER']?>" method="post" enctype="multipart/form-data" id="submit_form_<?=$arParams['ANCHOR_PARAMETER']?>" >
		       <input type="hidden"  id="event_type_id" name="PROPERTY[248]" value="78" />
				<input type="text" style="display:none;"  id="event_name"  value="SDP-033 Professional Scrum Master" name="PROPERTY[NAME][0]" style="display:none;">
				<input type="hidden" name="PROPERTY[313][0]" value="64888">
				<input  type="hidden" name="courseID" value="60345"/>
			   ...
			   <fieldset>
                ...
                <div class="centered">
                    <a href="#" onclick="$('form [name=iblock_add_<?=$arParams['ANCHOR_PARAMETER']?>]').submit();" class="btn submit">Зарегистрироваться</a>
