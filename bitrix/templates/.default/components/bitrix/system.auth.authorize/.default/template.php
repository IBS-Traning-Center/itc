...
<table class="data-table bx-auth-table">
	...
	?>
		<tr>
			...
			<input type="submit" style="border:1px solid #AACFE4;margin:2px 0 15px 0px;padding:4px 2px; width:150px;" name="Login" value="<?=GetMessage("AUTH_AUTHORIZE")?>" /></td>
		</tr>
	</tfoot>
</table>
<p>
<a href="/auth/registration.html?register=yes">Регистрация</a><br />
<a href="/auth/forgot_pass.html">Забыли свой пароль?</a>
</p>
