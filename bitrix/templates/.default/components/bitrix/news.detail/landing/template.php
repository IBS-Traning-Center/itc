...
<div class="social-share">
	...
	<a target="_blank" class="share-button facebook" href="https://www.facebook.com/dialog/feed?app_id=1421562351392582&link=<?=urlencode("http://www.luxoft-training.ru".$APPLICATION->GetCurDir())?>display=popup&caption=<?=rawurlencode("Luxoft Training: Курсы и тренинги для программистов, аналитиков, менеджеров проектов, тестировщиков")?>&name=<?=rawurlencode($share_title)?>&picture=http://www.luxoft-training.ru/images/landing/new_logo_67.gif&redirect_uri=<?=urlencode("http://www.luxoft-training.ru".$APPLICATION->GetCurDir())?>"></a>
	<a target="_blank" class="share-button vkontakte" href="http://vkontakte.ru/share.php?&description=<?=rawurlencode("Luxoft Training: Курсы и тренинги для программистов, аналитиков, менеджеров проектов, тестировщиков.")?>&title=<?=rawurlencode($share_title)?>&url=<?=urlencode("http://www.luxoft-training.ru".$APPLICATION->GetCurDir())?>&noparse=false"></a>
	<a target="_blank" class="share-button twitter" href="https://twitter.com/share?&text=<?=rawurlencode($share_title)?>&url=<?=urlencode("http://www.luxoft-training.ru".$APPLICATION->GetCurDir())?>&redirect_uri=<?=urlencode("http://www.luxoft-training.ru".$APPLICATION->GetCurDir())?>"></a>
