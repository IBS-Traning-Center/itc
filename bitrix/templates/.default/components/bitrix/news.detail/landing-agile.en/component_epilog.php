...
<?$coords["2"]=$coords["1"]-0.003?>
    ...
    <ul class="social">
        ...
        <li><a class="facebook" target="_blank" href="https://www.facebook.com/dialog/feed?app_id=1421562351392582&link=<?=urlencode("http://www.luxoft-training.com".$APPLICATION->GetCurDir())?>&display=popup&caption=<?=rawurlencode("Luxoft Training: High Standards of IT Training")?>&name=<?=rawurlencode($share_title)?>&redirect_uri=<?=urlencode("http://www.luxoft-training.ru".$APPLICATION->GetCurDir())?>">facebook</a></li>
        <li><a class="twitter" target="_blank" href="https://twitter.com/share?&text=<?=rawurlencode($share_title)?>&url=<?=urlencode("http://www.luxoft-training.com".$APPLICATION->GetCurDir())?>&redirect_uri=<?=urlencode("http://www.luxoft-training.ru".$APPLICATION->GetCurDir())?>"">twitter</a></li>
        <li><a class="linkedin" target="_blank" href="http://www.linkedin.com/shareArticle?mini=true&url=<?=urlencode("http://www.luxoft-training.com".$APPLICATION->GetCurDir())?>&title=<?=rawurlencode($share_title)?>&summary=<?=rawurlencode('Luxoft Training: High Standards of IT Training.')?>"">linkedin</a></li>
