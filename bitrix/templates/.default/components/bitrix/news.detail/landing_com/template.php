...
<div class="social-share">
	...
	<a target="_blank" class="share-button facebook" href="https://www.facebook.com/dialog/feed?app_id=1421562351392582&link=<?=urlencode("http://www.luxoft-training.com".$APPLICATION->GetCurDir())?>display=popup&caption=<?=rawurlencode(iconv("windows-1251", "UTF-8", $arResult["DETAIL_TEXT"]))?>&name=<?=rawurlencode(iconv("windows-1251", "UTF-8", $share_title))?>&picture=http://www.luxoft-training.ru/images/landing/new_logo_67.gif&redirect_uri=<?=urlencode("http://www.luxoft-training.ru".$APPLICATION->GetCurDir())?>"></a>
	<a target="_blank" class="share-button vkontakte" href="http://vkontakte.ru/share.php?&description=<?=rawurlencode(iconv("windows-1251", "UTF-8", $arResult["DETAIL_TEXT"]))?>&title=<?=rawurlencode(iconv("windows-1251", "UTF-8", $share_title))?>&url=<?=urlencode("http://www.luxoft-training.com".$APPLICATION->GetCurDir())?>&noparse=false"></a>
	<a target="_blank" class="share-button twitter" href="https://twitter.com/share?&text=<?=rawurlencode(iconv("windows-1251", "UTF-8", $share_title))?>&url=<?=urlencode("http://www.luxoft-training.ru".$APPLICATION->GetCurDir())?>&redirect_uri=<?=urlencode("http://www.luxoft-training.com".$APPLICATION->GetCurDir())?>"></a>
