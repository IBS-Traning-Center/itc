...
ul#navigation.section-items li{
...
<div id="tr_catalog">
<ul id="navigation" class="section-items">
<?
$bFlagIsCourse = false;
					...
					<div class="clases_wrapper">
						<div class="l w600">
                                <div>
                                    ...
                                    <a class="goaway" title="" href="/training/catalog/course.html?ID=<?=$arSection['PROPERTY_PP_COURSE_VALUE']?>"><?=$arSection['PROPERTY_PP_COURSE_NAME']?></a>
                                </div>
                        </div>
                        ...
                        <div class="clear"></div>
                        <?if ($arSection['PARAM']["PROPERTY_SHORT_DESCR_VALUE"]) {?>
                            <div style="font-size: 12px;line-height: 140%;color: #555555;">
