...
//iwrite($arResult["SECTIONS"]["NAME"]);
	...
	************/
	...
	$arFilter = array("IBLOCK_ID" => intval($arParams['ID_IBLOCK']),"ACTIVE" =>"Y", "SECTION_GLOBAL_ACTIVE" =>"Y", "SECTION_ACTIVE" =>"Y");
	$arSelect = array("ID","NAME","PROPERTY_IS_TYPE","PROPERTY_AUTHOR", "SORT", "IBLOCK_SECTION_ID");
	$rs_element = CIBlockElement::GetList(Array("NAME" => "ASC"), $arFilter, false, false, $arSelect);
