...
?><div id="photo_error"><?ShowError($arResult["ERROR_MESSAGE"]);?></div><?
...
if (!navigator.javaEnabled())
	document.getElementById('photo_error').innerHTML += "Запрещено использование Java.<br />";
</script><?
endif;
...
//	iu.addParam("RedirectUrl", "");
	...
	iu.activeXClassId = "101D2283-EED9-4BA2-8F3F-23DB860946EB";
	iu.activeXControlVersion = "5,0,10,0";
...
function InitThumbnailWriter()
{
	...
	t.activeXClassId = "A946C234-C89C-4894-AD57-158D9AEEB695";
