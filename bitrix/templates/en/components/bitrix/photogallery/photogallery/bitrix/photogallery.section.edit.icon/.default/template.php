...
if ($arParams["AJAX_CALL"] != "Y"):
	...
	if (!empty($arResult["SECTION"]["SECTION_LINK"])):
		?><a href="<?=$arResult["SECTION"]["SECTION_LINK"]?>" title="<?=GetMessage("P_BACK_UP_TITLE")?>" <?
...
?><form method="post" action="<?=POST_FORM_ACTION_URI?>" name="form_photo" id="form_photo" onsubmit="return CheckFormEditIcon(this);"><?
