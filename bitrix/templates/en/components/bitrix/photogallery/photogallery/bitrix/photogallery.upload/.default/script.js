...
var PhotoClass =
{
	...
	{
		var thumbnail1 = getImageUploader("Thumbnail1");
		var bEmptyFields = {"Title" : false, "Tag" : false, "Description" : false};
		var sFirstFields = {"Title" : false, "Tag" : false, "Description" : false};
		...
		if (this.Uploader && thumbnail1 && this.active.length > 0)
		{
			...
			for (var ii = 0; ii < this.active.length; ii++)
			{
				...
				if (bEmptyFields["Title"] && bEmptyFields["Tags"] && bEmptyFields["Description"])
				break;
			}
	...
	HideDescription: function()
	{
		...
		if (this.Uploader && thumbnail1)
		{
			...
			for (var ii = 0; ii < this.active.length; ii++)
			{
				if (this.Temp["Fields"] && this.Temp["Fields"]["Title"] != arValue["Title"])
