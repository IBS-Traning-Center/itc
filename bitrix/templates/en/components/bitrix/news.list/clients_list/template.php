...
<? $client_otzyv = nl2br($arItem['PROPERTIES']['otzyv']['VALUE']); ?>
    		<td class="client_speak_name">
				...
				<?if($arParams["DISPLAY_PICTURE"]!="N" && is_array($arItem["PREVIEW_PICTURE"])):?>
					...
					<?else:?>
						<img class="" border="0" src="<?=$arItem["PREVIEW_PICTURE"]["SRC"]?>" width="<?if ($arItem["PREVIEW_PICTURE"]["WIDTH"]>120) {?>120<? } else {?><?=$arItem["PREVIEW_PICTURE"]["WIDTH"]?><? } ?>"  alt="<?=$arItem["PREVIEW_PICTURE"]["ALT"]?>" title="<?=$arItem["NAME"]?>" />
					<?endif;?>
				<?endif?>
	    		...
	    		<span class="author_name"></span><br />--><?=$client_otzyv?></p>
