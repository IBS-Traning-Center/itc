...
<li style="padding:0px 0px 3px 0px ;">
		<a style="font-size: 12px; color:#0033CC;" title="Подробнее о курсе: <?=$value['name']?>" href="http://ibs-training.ru/training/catalog/course.html?ID=<?=$value[course_id]?>&ID_TIME=<?=$value[time_id]?>&r1=dneprqa&r2=schedule"><?= $value["name"] ?></a> <?= $value["city"] ?>, <span class="lux_span_date"  style="font-size: 12px"> <?=$value["startdate"] ?> </span>
</li>
<? $index = $index + 1; ?>
<? } ?>
<?
...
<span class="lux_more" style="padding:3px 0px 0px 0px; font-size: 14px; font-family: trebuchet MS; font-weight: normal; color:#666666; text-decoration: none;">
	<a style="color:#666666;" href="http://ibs-training.ru/events/seminar/?r1=dneprqa&r2=schedule" title="">
...
<span class="lux_more" style="padding:3px 0px 0px 0px; font-size: 14px; font-family: trebuchet MS; font-weight: normal; color:#666666; font-decoration: none;">
	<a style="color:#666666;" href="http://ibs-training.ru/timetable/index.html?city=kiev&r1=dneprqa&r2=schedule" title="Полное расписание курсов Учебного Центра Luxoft">
		Полное расписание
	</a>
</span><br />
