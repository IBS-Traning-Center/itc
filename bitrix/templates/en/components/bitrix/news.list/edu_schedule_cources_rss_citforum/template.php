...
<div id="lux_title" align="left" style="font-size: 17px;font-weight: bold;  margin-bottom:5px;"><a target="_blank" style="color:#FC711B;" href="http://ibs-training.ru/?r1=cit&r2=schedule" title="Обучение от экспертов в сфере разработки ПО по IT специальностям">Учебный Центр Luxoft</a></div>
...
<li style="padding:0px 0px 3px 0px ;">
		<a style="font-size: 13px; color:#14617f; " href="http://ibs-training.ru/training/catalog/course.html?ID=<?=$value[course_id]?>&ID_TIME=<?=$value[time_id]?>&r1=cit&r2=schedule"><?= $value["name"] ?></a>,<span class="lux_span_date"  style="font-size: 13px"> <?=$value["startdate"] ?> </span>
</li>
<? $index = $index + 1; ?>
<? } ?>
<?
...
<span class="lux_more" style="padding:5px 0px 0px 0px; font-size: 13px;  font-weight: bold">
	<a style="color:#14617f;" href="http://ibs-training.ru/timetable/?r1=cit&r2=schedule" title="Полное расписание">
