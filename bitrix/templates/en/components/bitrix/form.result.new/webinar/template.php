...
<?if (($arResult["isFormNote"] == "Y")  and ($arResult["isFormErrors"]=="N") and $_GET["formresult"]=="addok"){?>
 <p>Спасибо за регистрацию на вебинар. Вам было отправлено письмо с дальнейшими указаниями. По всем вопросам можно обратиться по адресу:<br />
<span class="links"> <a href="mailto:education@ibs.ru">education@ibs.ru</a></span>
