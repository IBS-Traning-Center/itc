...
<table width="100%">
	...
	<tr>
		<td width="30%">
			<input type="submit"  style="border:1px solid #AACFE4;margin:2px 0 15px 0px;padding:4px 2px; width:150px;" value="<?echo GetMessage("SALE_REFRESH")?>" name="BasketRefresh"><br />
			<!--<?echo GetMessage("SALE_REFRESH_DESCR")?>-->
			Нажмите эту кнопку, чтобы пересчитать, удалить или отложить выбранные вами услуги.
			<br />
		</td>
		<td align="right" width="40%">&nbsp;</td>
		<td align="right" width="30%">
			<input type="submit"   style="border:1px solid #AACFE4;margin:2px 0 15px 0px;padding:4px 2px; width:150px;" value="<?echo GetMessage("SALE_ORDER")?>" name="BasketOrder"  id="basketOrderButton2"><br />
			<!--<?echo GetMessage("SALE_ORDER_DESCR")?>-->
			Нажмите эту кнопку, чтобы заказать выбранные вами услуги
			<br />
		</td>
	</tr>
</table>
