...
<form method="post" action="<?=$arParams["NEW_URL"]?><?=$arParams["SEF_MODE"] != "Y" ? (strpos($arParams["NEW_URL"], "?") === false ? "?" : "&")."WEB_FORM_ID=".$arParams["WEB_FORM_ID"] : ""?>">
<p>
<input type="submit" value="<?=GetMessage("FORM_ADD")?>&nbsp;&nbsp;>>" />
</p>
</form>
				...
				<tr>
					...
					?>
						...
						?>
								...
								<input type="hidden" name="STATUS_PREV_<?=$GLOBALS["f_ID"]?>" value="<?=$arRes["STATUS_ID"]?>" />
