...
<table class="form-table data-table">
	...
	<tbody>
		...
		<tr>
			...
			<?if ($arQuestion["ANSWER_VALUE"]["ANSWER_IMAGE"]):?>
				<?if (strlen($arQuestion["ANSWER_VALUE"]["USER_TEXT"]) > 0):?><?=$arQuestion["ANSWER_VALUE"]["USER_TEXT"]?><br /><?endif?>
				<img src="<?=$arQuestion["ANSWER_VALUE"]["ANSWER_IMAGE"]["URL"]?>" <?=$arQuestion["ANSWER_VALUE"]["ANSWER_IMAGE"]["ATTR"]?> border="0" />
			<?elseif ($arQuestion["ANSWER_VALUE"]["ANSWER_FILE"]):?>
				<a title="<?=GetMessage("FORM_VIEW_FILE")?>" target="_blank" href="<?=$arQuestion["ANSWER_VALUE"]["ANSWER_FILE"]["URL"]?>"><?=$arQuestion["ANSWER_VALUE"]["ANSWER_FILE"]["NAME"]?></a><br />(<?=$arQuestion["ANSWER_VALUE"]["ANSWER_FILE"]["SIZE_FORMATTED"]?>)<br />[&nbsp;<a title="<?=str_replace("#FILE_NAME#", $arQuestion["ANSWER_VALUE"]["ANSWER_FILE"]["NAME"], GetMessage("FORM_DOWNLOAD_FILE"))?>" href="<?=$arQuestion["ANSWER_VALUE"]["ANSWER_FILE"]["URL"]?>&action=download"><?=GetMessage("FORM_DOWNLOAD")?></a>&nbsp;]
			<?elseif (strlen($arQuestion["ANSWER_VALUE"]["USER_TEXT"])):?>
				<?=$arQuestion["ANSWER_VALUE"]["USER_TEXT"]?>
			<?else:?>
				<?if (strlen($arQuestion["ANSWER_VALUE"]["ANSWER_TEXT"])>0):?>
				[<span class="form-anstext"><?=$arQuestion["ANSWER_VALUE"]["ANSWER_TEXT"]?></span>]
					<?if (strlen($arQuestion["ANSWER_VALUE"]["ANSWER_VALUE"])>0):?>&nbsp;(<span class="form-ansvalue"><?=$arQuestion["ANSWER_VALUE"]["ANSWER_VALUE"]?></span>)<?endif?>
				<br />
				<?endif;?>
			<?endif;?>
			</td>
