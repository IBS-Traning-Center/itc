...
<?
	      ...
	      $vacancy_description_en = nl2br($arResult['PROPERTIES']['description_ru']['VALUE']['TEXT']);
	      $vacancy_requirements_en = nl2br($arResult['PROPERTIES']['requirements_ru']['VALUE']['TEXT']);
...
<div class="vacancyitem">
        <p><a class="title" href="/ru/careers/<?=$vacancy_id?>/"><?=$vacancy_name?></a><? if ($vacancy_hot=="hot"):?> <span  class="feathered"> -  <? echo GetMessage("HOT"); ?>!</span> <?endif;?></p>
