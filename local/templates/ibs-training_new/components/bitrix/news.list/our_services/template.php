...
<section class="our-services spaces bg--gray">
	<div class="main-page-heading"><?$APPLICATION->IncludeFile(SITE_DIR . 'include/main_page/our-services-title.php', [], ['MODE' => 'html', 'NAME' => 'Заголовок']); ?></div>

	<div class="our-services__wrap">
		<div class="our-services__image-wrap">
