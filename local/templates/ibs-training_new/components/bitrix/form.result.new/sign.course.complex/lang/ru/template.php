...
$MESS['OPEN_DATES_TITLE'] = 'Открытая дата';
$MESS['PHYS_FACE_TAB_TEXT'] = 'Физ. лицо — #PRICE# ₽';
$MESS['UR_FACE_TAB_TEXT'] = 'Юр. лицо — #PRICE# ₽';
$MESS['PRICE_FOR_UR_FACE'] = '#PRICE# ₽ — для юр. лиц';
$MESS['RETURN_MONEY_TEXT'] = 'Как вернуть до 90% стоимости';
$MESS['SIGN_COURSE_TITLE'] = 'Записаться на курс';