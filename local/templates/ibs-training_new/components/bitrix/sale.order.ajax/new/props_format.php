				...
				<div>
					...
					foreach ($arSource as $arProperties)
					{
                        ...
                        <div class="clientsInfo">
                            ...
                            <div class="bx_block r3x1">
                                <div class="clientInfo">
                                    <div>
                                        <div class="bx_block r1x3 pt8">ФИО<span class="bx_sof_req">*</span></div>
                                        <div class="bx_block r3x1">
                                            <input type="text" name="full-name" maxlength="250" size="0" value="">
                                        </div>
                                        <div style="clear: both;"></div>
                                    </div>
                                    <div>
                                        <div class="bx_block r1x3 pt8">Дата рождения<span class="bx_sof_req">*</span></div>
                                        <div class="bx_block r3x1">
                                            <input type="text" name="date-birth" maxlength="250" size="0" value="">
                                        </div>
                                        <div style="clear: both;"></div>
                                    </div>
                                    <div>
                                        <div class="bx_block r1x3 pt8">СНИЛС <br>(только граждане РФ)<span class="bx_sof_req">*</span></div>
                                        <div class="bx_block r3x1">
                                            <input type="text" name="SNILS" maxlength="250" size="0" value="">
                                        </div>
                                        <div style="clear: both;"></div>
                                    </div>
                                    <div>
                                        <div class="bx_block r1x3 pt8">Телефон<span class="bx_sof_req">*</span></div>
                                        <div class="bx_block r3x1">
                                            <input type="text" name="phone" maxlength="250" size="0" value="">
                                        </div>
                                        <div style="clear: both;"></div>
                                    </div>
                                    <div>
                                        <div class="bx_block r1x3 pt8">Адрес Обучающегося<span class="bx_sof_req">*</span></div>
                                        <div class="bx_block r3x1">
                                            <input type="text" name="address" maxlength="250" size="0" value="">
                                        </div>
                                        <div style="clear: both;"></div>
                                    </div>
                                </div>
                                <span class="checkout main-button" id="js_add_user_info">Добавить участника</span>
                                <textarea id="clientInfoAllResult" rows="<?=$rows?>" cols="<?=$arProperties["SIZE1"]?>" name="<?=$arProperties["FIELD_NAME"]?>" id="<?=$arProperties["FIELD_NAME"]?>" class="h-content"><?=$arProperties["VALUE"]?></textarea>
                            </div>
                            <div style="clear: both;"></div>
                        </div>
						...
						elseif ($arProperties["TYPE"] == "SELECT")
						{
							...
							<div class="bx_block r3x1">
								<select class="no_redraw" name="<?=$arProperties["FIELD_NAME"]?>" id="<?=$arProperties["FIELD_NAME"]?>" size="<?=$arProperties["SIZE1"]?>">
									<?
