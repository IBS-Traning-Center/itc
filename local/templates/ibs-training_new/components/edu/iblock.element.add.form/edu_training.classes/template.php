...
$arResult["PROPERTY_LIST_FULL"][407]["NAME"] = "Желаемое место проведения класса";
$arResult["OWN_TITLE"]  = str_replace("курс","класс",$arResult["OWN_TITLE"]);
?>
<? //iwrite($arResult);
?>
...
/*				<!--<tr>
		...
		<?endif?>
					...
					<input onclick="javascript: pageTracker._trackEvent('FILL_FORM','COURSE','<?=$_REQUEST['ID']?>');" type="submit" class="but" name="iblock_submit" value="Зарегистрироваться" />
