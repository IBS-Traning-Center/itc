...
$MESS["SOA_TEMPL_ORDER_SUC1"] = "Вы можете следить за выполнением своего заказа в <a href=\"#LINK#\">Персональном разделе сайта</a>. Обратите внимание, что для входа в этот раздел вам необходимо будет ввести email и пароль пользователя сайта.";
...
$MESS["OFFERTA_TEMPL_PAY_LINK_WITH"] = "Для того чтобы открыть cчет-оферту (1), нажмите на <a href=\"#LINK#\">ссылку</a>.";
$MESS["OFFERTA_TEMPL_PAY_LINK_WITHOUT"] = "Для того чтобы открыть cчет-оферту (без подписей со стороны УЦ Luxoft) (2), нажмите на <a href=\"#LINK#\">ссылку</a>.";
...
$MESS["SOA_TEMPL_SUM_SUMMARY"] = "Услуг на:";
...
$MESS["STOF_MY_PASSWORD"] = "Задать Email и пароль";
$MESS["STOF_RE_PASSWORD"] = "Повтор пароля";
$MESS["STOF_SYS_PASSWORD"] = "Пароль сгенерировать автоматически";
