...
<div id="stylized" class="myform" style="background: none repeat scroll 0 0 #EEEEEE;">
...
<?}?>
<form name="iblock_add_<?=$arParams['ANCHOR_PARAMETER']?>" action="<?=POST_FORM_ACTION_URI?><?=$arParams['URL_FORM_PARAMETER']?>#<?=$arParams['ANCHOR_PARAMETER']?>" method="post" enctype="multipart/form-data" id="submit_form_<?=$arParams['ANCHOR_PARAMETER']?>" >
...
/*				<!--<tr>
		...
		<?endif?>
					...
					<input onclick="javascript: pageTracker._trackEvent('FILL_FORM','COURSE','<?=$_REQUEST['ID']?>');" type="submit" class="but" name="iblock_submit_<?=$arParams['ANCHOR_PARAMETER']?>" value="Зарегистрироваться" />
