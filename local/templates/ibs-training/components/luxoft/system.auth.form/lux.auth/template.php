...
<form method="post" target="_top" action="<?=$arResult["AUTH_URL"]?>">
	...
	<table width="95%">
			<tr>
				<td colspan="2">
				E-mail:<br />
				<input type="text" name="USER_LOGIN" maxlength="80" value="<?=$arResult["USER_LOGIN"]?>" size="30" /></td>
			</tr>
			<tr>
				<td colspan="2">
				<?=GetMessage("AUTH_PASSWORD")?>:<br />
				<input type="password" name="USER_PASSWORD" maxlength="50" size="30" /></td>
			</tr>
		<?
		...
		?>
			...
			<tr>
				<td colspan="2"><a href="/auth/forgot_pass.html"><?=GetMessage("AUTH_FORGOT_PASSWORD_2")?></a></td>
			</tr>
	</table>
</form>
</div>
...
<?else:?>
<div style="float:left; border-right:1px solid #eee; margin-right:20px; padding-right:30px;">
<strong><span class="links ">Расписание курсов по направлениям:</span></strong><br /><br />
<blockquote>
<ul>
<li><a href="/timetable/index.html?city=online&type=courses">Онлайн</a></li>
<li><a href="/timetable/index.html?city=moscow&type=courses">Москва</a></li>
<li><a href="/timetable/index.html?city=omsk&type=courses">Омск</a></li>
<li><a href="/timetable/index.html?city=kiev&type=courses">Киев</a></li>
<li><a href="/timetable/index.html?city=spb&type=courses">Санкт-Петербург</a></li>
<li><a href="/timetable/index.html?city=odessa&type=courses">Одесса</a></li>
<li><a href="/timetable/index.html?city=dnepr&type=courses">Днепропетровск</a></li>
</ul>
</blockquote>
</div>

<div style="float:left;">
<strong><span class="links ">Расписание Школ:</span></strong><br /><br />
<blockquote>
<ul>
<li><a href="/timetable/index.html?city=online&type=schools">Онлайн</a></li>
<li><a href="/timetable/index.html?city=moscow&type=schools">Москва</a></li>
<li><a href="/timetable/index.html?city=omsk&type=schools">Омск</a></li>
<li><a href="/timetable/index.html?city=kiev&type=schools">Киев</a></li>
<li><a href="/timetable/index.html?city=spb&type=schools">Санкт-Петербург</a></li>
<li><a href="/timetable/index.html?city=odessa&type=schools">Одесса</a></li>
<li><a href="/timetable/index.html?city=dnepr&type=schools">Днепропетровск</a></li>
</ul>
</blockquote>
</div>
<div class="clear"></div>
