...
<div class="section-box" style="background-color: #f2f2f2">
    <div class="section-box__container container">
        ...
        <div class="section-box__content">
            <form class="form callback-mini" name="frdo-template" data-form-type="webform">
                ...
                <div class="form__content">
                    <div class="fields">
                        ...
                        <input type="hidden" name="COURSE-CODE" value="<?=$arResult['PROPERTIES']['COURSE_CODE']['VALUE']?>">
                        <input type="hidden" name="COURSE-NAME" value="<?=$arResult['PROPERTIES']['COURSE_NAME']['VALUE']?>">
                        <input type="hidden" name="COURSE-DATE" value="<?=$arResult['PROPERTIES']['COURSE_DATE_START']['VALUE'] . ' - ' . $arResult['PROPERTIES']['COURSE_DATE_END']['VALUE']?>">
                        <label class="field-box">
                            <input class="field" type="text" placeholder="Название курса" value="<?=$arResult['PROPERTIES']['COURSE_NAME']['VALUE']?>" disabled="">
                        </label>
                        <label class="field-box">
                            <input class="field" type="text" placeholder="Дата проведения" value="<?=$arResult['PROPERTIES']['COURSE_DATE_START']['VALUE'] . ' - ' . $arResult['PROPERTIES']['COURSE_DATE_END']['VALUE']?>" disabled="">
                        </label>
                        <label class="field-box">
