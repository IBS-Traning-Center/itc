    ...
    <!-- <div class="table" id="s4">
        ...
        <div class="map" id="s5">
            <div class="info">
                <ul>
                    <li>
                        <span class="ico"><img src="/it-guru/images/ico-addr.png" alt=""></span>
                        <?=$arAdress["ADDRESS"]?>
                    </li>
                    <li>
                        <span class="ico"><img src="/it-guru/images/ico-phone.png" alt=""></span>
                         <?=$arAdress["PHONE"]?>
                    </li>
                    <li>
                        <span class="ico"><img src="/it-guru/images/ico-mail.png" alt=""></span>
                        <a href="mailto:&#101;&#100;&#117;&#099;&#097;&#116;&#105;&#111;&#110;&#064;&#108;&#117;&#120;&#111;&#102;&#116;&#046;&#099;&#111;&#109;">&#101;&#100;&#117;&#099;&#097;&#116;&#105;&#111;&#110;&#064;&#108;&#117;&#120;&#111;&#102;&#116;&#046;&#099;&#111;&#109;</a>
                    </li>
                </ul>
                <div class="note">
                    <span class="ico"><img src="/it-guru/images/ico-note.png" alt=""></span>
...
<div class="overlay" id="overlay-form">
	...
	<?$template="landing_en";?>
	<?}?>
	<?$APPLICATION->IncludeComponent("edu:iblock.element.add.form.course", "landing-itguru", array(
		"IBLOCK_TYPE" => "edu",
		"IBLOCK_ID" => "64",
		"STATUS_NEW" => "N",
		"LIST_URL" => "",
		...
		"PROPERTY_TYPE_EVENT" => "205",
		"PROPERTY_TEXT_TO_DO" => "Регистрация на мастер-класс",
		"PROPERTY_EVENT_NAME" => "",
		...
		"SHOW_CITIES" => "N",
		"COMPONENT_TEMPLATE" => "landing-itguru"
	),
	false
);?>
   <?} else {?>
        ...
        <div>
            ...
            <p>Мы с удовольствием ответим на все интересующие Вас вопросы! Пишите нам на <a href="mailto:<?=EMAIL_ADDRESS?>"><?=EMAIL_ADDRESS?></a>.</p>
        </div>
    <?}?>
</div>
