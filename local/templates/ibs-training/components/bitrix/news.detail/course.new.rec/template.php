...
global $gCourseFormat, $arEventInfo;
$gCourseFormat = false;
...
<?
if (count($arResult['ADDITONAL']['LINKED']) > 0 || $course_addsources || $course_other) { ?>
    <div id="reccomend" class="bg not-main-page gray">
        <div class="frame">
                        ...
                        <div class="reccomend-item">
                                ...
                                <div class="req-hours">
                                    <span class="hours"><?
                                        if (strlen($arLinkedCourses['COURSE_DURATION']) > 0) {
                                            echo $arLinkedCourses['COURSE_DURATION'] . " ч.";
                                        } ?></span>
                            ...
                            <div class="row">
                                ...
                                <div class="req-hours sw100p">
                                    ...
                                    <a class="reg-link"
                                       href="/training/catalog/course.html?ID=<?= $arLinkedCourses['COURSE_ID'] ?>">Записаться</a>
                                </div>
                            </div>
                        </div>
                <?} ?>
            ...
            <?
            if ($course_addsources || $course_other) { ?>
                <div class="row course-main-info clearfix">
                    ...
                    if ($course_other) { ?>
                        <div class="small-2 <?
                        if ($course_addsources) { ?>padding-left<?
                        } ?>">
