...
?>
<div id="header">
    <strong class="logo"><a href="/">IBS Training Center</a></strong>
    ...
    <ul id="nav">
        ...
        <?if ($arResult["COURSE"]["SCHEDULED"]["PROPERTIES"]["course_code"]["VALUE"]=="SDP-033") {?>
            <li><a href="#s4">Сертификация</a></li>
        <?}?>
...
<div id="banner-mobile-bg" style="display:none; background-image: url('<?=CFile::GetPath($arResult["PROPERTIES"]["BANNER_LINK_MOBILE"]["VALUE"])?>"></div>
    ...
    if (false) {?>
        ...
        <?if (
            $arResult["PROPERTIES"]["TRAINER_PHOTO_1"]["VALUE"]
            && (
                $arResult["PROPERTIES"]["TRAINER_HEADING"]["VALUE"]
                || $arResult["PROPERTIES"]["TRAINER_DESCRIPTION"]["VALUE"]
            )
        ) {?>
            <div class="person">
                <div class="image">
        ...
        <?}?>
        <?if (
            $arResult["PROPERTIES"]["TRAINER_PHOTO_2"]["VALUE"]
            && (
                $arResult["PROPERTIES"]["TRAINER_HEADING_2"]["VALUE"]
                || $arResult["PROPERTIES"]["TRAINER_DESCRIPTION_2"]["VALUE"]
            )
        ) {?>
        ...
        <div class="program-b">
            ...
            <?//if($arResult["PROPERTIES"]["SCHOOL_STRUCTURE"]["VALUE"]) {?>
                ...
                <div class="bonuses">
                    ...
                    <div class="bonus-txt">После окончания школы выдаётся сертификат на бланке IBS Training Center</div>
                </div>
            </div>
        </div>
    </div>
