...
<TR  class="ewTableAltRow"  onmouseover='ew_mouseover(this);' onmouseout='ew_mouseout(this);'>
	...
	<TD class="td_name"><p><A href="/training/catalog/course.html?ID=<?=$value[course_id]?>"><?= $value["name"] ?></A><? if (strlen($value["prepod_surname"])>0) {?><br />тренер: <a class="blue" href="/about/experts/<?=$value['prepod_code']?>.html"><?=$value["prepod_surname"];?> <?=$value["prepod_name"];?></a><? } ?></p></TD>
