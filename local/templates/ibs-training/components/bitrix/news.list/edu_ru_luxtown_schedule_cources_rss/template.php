...
<tr>
	...
	<td class="lux_td_name"><a target="_blank" href="http://www.luxoft-training.ru/internal/catalog/<?=$value[course_code]?>/"><?= $value["name"] ?></a>
				<? if (strlen($value["prepod_surname"])>0)  {?>
					<span class="lux_coach"><br />тренер:
					<? if ($value["prepod_active"]=="Y") {?>
						<a class="orange" target="_blank" title="Перейти на страницу-карточку преподавателя" href="http://www.luxoft-training.ru/about/experts/<?=$value['prepod_code']?>.html">
