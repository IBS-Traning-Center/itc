	...
	if (!empty($arSource))
	{
		foreach($arSource as $arProperties)
		{
			...
			else
			{
				...
				<tr <?if ((($arProperties["ID"]=="56" || $arProperties["ID"]=="57") && (!in_array("34", $arGroups))) || $arProperties["ID"]=="78" || $arProperties["ID"]=="79") {?>style='display: none;'<?}?>>
					
					<td style="width: 250px; vertical-align: top;" valign="top" align="right">
					...
					<td style="text-align: left;" class="form-section">
						<?
