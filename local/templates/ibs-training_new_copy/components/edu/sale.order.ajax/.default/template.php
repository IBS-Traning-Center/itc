...
<blockquote>
<ul>
<li>необходимо оплатить счет-оферту (1), а так же сообщить об оплате на <a href="<?=EMAIL_ADDRESS?>"><?=EMAIL_ADDRESS?></a>, указав в письме номер счета-оферты</li>
...
<li>после подписания вами закрывающих документов, акт необходимо направить по адресу 127018, Москва, ул. Складочная, д. 3, стр. 1. Марии Зиборовой
 ...
 <div class="botborder_no_indent"></div>
									...
									<br /><br />
									<div class="links">Если у вас возникли вопросы по договору-оферте, юридическое лицо не является резидентом РФ или не имеет представительства на территории РФ, просьба написать письмо на <a href="mailto:<?=EMAIL_ADDRESS?>"><?=EMAIL_ADDRESS?> </a> или воспользоваться <a href="/mail/form.html">формой</a> на сайте</div>
...
<?/*			<div class="cart-oferta">
				...
				<br />
				<p style="padding:5px 20px 10px 0;">Если у вас возникли вопросы по договору-оферте, юридическое лицо не является резидентом РФ или имеет представительство на территории РФ, просьба написать письмо на <a href="mailto:<?=EMAIL_ADDRESS?>"><?=EMAIL_ADDRESS?></a></p>
			</div>*/?>

        <? } ?>
        <br />
                <div class="order-buttons">
				<input type="submit" class="button_enabled"  id="basketOrderButton2" name="submitbutton" onclick="submitForm('Y');" value="<?=GetMessage("SOA_TEMPL_BUTTON")?>">
				</div>
			</div>
		</div>
