...
<?foreach($arResult["ITEMS"] as $arItem):?>
        ...
        //echo "schedule_city=$schedule_city";
...
<TR  class="ewTableAltRow"  onmouseover='ew_mouseover(this);' onmouseout='ew_mouseout(this);'>
	<TD class="td_name"><P align="left"><A href="/training/catalog/course.html?ID=<?=$value[course_id]?>"><?= $value["name"] ?></A></P></TD>
	<TD class="td_date"><P align="left"><NOBR><?= $value["startdate"] ?></NOBR></P></TD>
	<TD class="td_price"><NOBR><?=$value["city_name"];?></NOBR></TD>
	<TD class="td_time"><NOBR><?=$value["price"]?> <?if ($value["valuta"]=="Рубли") {?> р.<? }else{ ?> грн. <? } ?></NOBR></TD>
