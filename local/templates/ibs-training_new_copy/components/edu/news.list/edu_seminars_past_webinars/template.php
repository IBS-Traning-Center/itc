                    ...
                    <div class="time-price-wrapper clearfix">
                        <? if (count($arResult['TRENER_INFO'][$arItem['ID']])) { ?>
                            <div class="trener-info">Тренер: 
                                <a title="Перейти на страницу-карточку преподавателя" href="/about/experts/<?= $arResult['TRENER_INFO'][$arItem['ID']]['CODE'] ?>.html"><?= $arResult['TRENER_INFO'][$arItem['ID']]['NAME'] ?> <?= $arResult['TRENER_INFO'][$arItem['ID']]['~PROPERTY_EXPERT_NAME_VALUE'] ?></a>
                            </div>
                        <? } ?>
