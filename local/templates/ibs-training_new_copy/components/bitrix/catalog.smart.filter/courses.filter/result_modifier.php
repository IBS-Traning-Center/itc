...
foreach ($arResult['ITEMS'] as $item) {
    if ($item['CODE'] == 'FREE_COURSE') {
        $freeCourseInfo = $item;
    } elseif ($item['CODE'] == 'COURSE_WITH_DISCOUT') {
        $courseHasDiscount = $item;
    }
}

$arResult['FREE_COURSE'] = $freeCourseInfo;
$arResult['COURSE_WITH_DISCOUNT'] = $courseHasDiscount;