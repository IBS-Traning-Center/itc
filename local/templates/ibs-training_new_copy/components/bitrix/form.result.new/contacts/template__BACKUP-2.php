...
<? $arResult["FORM_HEADER"] = str_replace("form name=\"contacts\"", "form name=\"contacts\" id=\"submit_contacts\"", "$arResult[FORM_HEADER]"); ?>
	<?=$arResult["FORM_HEADER"]?>
		...
		<? } ?>
<p>Нажимая кнопку "Отправить", вы соглашаетесь на обработку и хранение ваших персональных данных. Сбор и обработка Ваших Персональных данных осуществляются с соблюдением законности и конфиденциальности.</p>
