...
<div class="main-feedback-form-block <?= $arParams['CUSTOM_CLASSES']; ?>" id="newsMagnetFormBlock">
    <div class="container main-feedback-form-container" style="display: block">
        <div class="row g-4 g-xxl-5">
            <?php if ($arParams['MAGNET_BUTTON_NAME']) : ?>
                <div class="col-12 col-xl 6">
                    <h2 class="title--h2"><?= $arParams['MAGNET_BUTTON_NAME'] ?></h2>
                </div>
            <?php endif; ?>
            <div class="col-12 col-xl 6">
...
<?php if ($arResult["FORM_NOTE"]) : ?>
    ...
    <script>
        ...
        function reloadPage()
        {
            ...
            url.searchParams.set('scrollTo', 'newsMagnetFormBlock');
