...
<div id="lux_block" style="text-align: left; font-size: 10px; font-weight: normal; font-family:Arial, sans-serif; width:240px; height:398px;>
<div style="padding:5px;">
<div id="lux_title" align="left" style="font-size: 17px;font-weight: bold;  margin-bottom:5px;"><a target="_blank" style="color:#FC711B;" href="http://www.luxoft-training.ru/?r1=cit&r2=schedule" title="Обучение от экспертов в сфере разработки ПО по IT специальностям">Учебный Центр Luxoft</a></div>
<div id="lux_nearest" align="left" style="font-size: 15px; font-weight: bold;margin-bottom:5px; color:#FC711B;">Ближайшие тренинги:</div>

<!-- COURSE BLOCK -->
<div id="lux_tr_course">
<ul style="font-size: 13px; list-style:none; margin:0 0 5px 0px; padding:0px;">
<?
	$index = 0;
...
<li style="padding:0px 0px 3px 0px ;">
		<a style="font-size: 13px; color:#14617f; " href="http://www.luxoft-training.ru/training/catalog/course.html?ID=<?=$value[course_id]?>&ID_TIME=<?=$value[time_id]?>&r1=cit&r2=schedule"><?= $value["name"] ?></a>,<span class="lux_span_date"  style="font-size: 13px"> <?=$value["startdate"] ?> </span>
</li>
<? $index = $index + 1; ?>
<? } ?>
<?
...
<span class="lux_more" style="padding:5px 0px 0px 0px; font-size: 13px;  font-weight: bold">
	<a style="color:#14617f;" href="http://www.luxoft-training.ru/timetable/?r1=cit&r2=schedule" title="Полное расписание">
