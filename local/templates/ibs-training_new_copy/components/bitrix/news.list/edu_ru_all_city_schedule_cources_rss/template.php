...
<? } ?>
<tr>
	<td class="lux_td_name"><a href="http://www.luxoft-training.ru/training/catalog/course.html?ID=<?=$value[course_id]?>"><?= $value["name"] ?></a></td>
	...
	<td class="lux_td_price"><nobr><?=$value["price"]?> <?if ($valuta=="Рубли") {?> р.<? }else{ ?> $ <? } ?></nobr></td>
</tr>
<?
