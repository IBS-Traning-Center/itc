...
<table cellSpacing="0" cellPadding="5" border="0" class="edu">
	...
	<?foreach($arResult["ITEMS"] as $arItem):?>
		...
		while($ob = $res->GetNextElement())
		{
			...
			<div class="lux_course"><span class="lux_code_name"><a href="http://www.luxoft-training.ru/training/catalog/course.html?ID=<?=$arFields['ID']?>"><?=$arFields['CODE']?> <?=$arFields['NAME']?></a></span></div>
		<?	//print_r($arFields);
		}
		?>
		</td>
