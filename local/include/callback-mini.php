<form class="form callback-mini" name="callback-mini" data-form-type="webform" data-form-id="28">
    ...
    <div class="form__content">
        <div class="fields _hidden" style="display: none">
            ...
            <label class="agree-text"><input checked="checked" name="agree-2" value="Y" type="checkbox">Я ознакомлен с порядком обработки моих персональных данных согласно <a style="text-decoration: underline;" target="_blank" href="/privacy-policy/">Privacy Policy</a>.</label>
        </div>
