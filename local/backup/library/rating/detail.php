...
$APPLICATION->SetPageProperty("blue_title", "Рейтинг IT-курсов");
$APPLICATION->SetTitle("Рейтинг IT-курсов");
?><?
  ...
  (function() {
	...
	$(document).ready(function(){
							$("#ya_share").one("click", function() {
								pageTracker._trackEvent('SocialBlock', 'Rating', 'All');
							});
							$(".b-share-icon_yaru").click(function() {
								pageTracker._trackEvent('SocialBlock', 'Rating', 'Ya.ru');
							});
							$(".b-share-icon_vkontakte").click(function() {
								pageTracker._trackEvent('SocialBlock', 'Rating', 'Vkontakte');
							});
							$(".b-share-icon_facebook").click(function() {
								pageTracker._trackEvent('SocialBlock', 'Rating', 'Facebook');
							});
							$(".b-share-icon_twitter").click(function() {
								pageTracker._trackEvent('SocialBlock', 'Rating', 'Twitter');
							});
							$(".b-share-icon_odnoklassniki").click(function() {
								pageTracker._trackEvent('SocialBlock', 'Rating', 'Odnoklassniki');
							});
							$(".b-share-icon_lj").click(function() {
								pageTracker._trackEvent('SocialBlock', 'Rating', 'LifeJournal');
							});
							$(".b-share-icon_moikrug").click(function() {
								pageTracker._trackEvent('SocialBlock', 'Rating', 'MoiKrug');
							});
							$(".b-share-icon_evernote").click(function() {
								pageTracker._trackEvent('SocialBlock', 'Rating', 'Evernote');
							});
