...
<?LocalRedirect("/corporate/business_cases/".$_REQUEST["CODE"]."/", false, "301 Moved permanently");?>
?><?$APPLICATION->IncludeComponent("bitrix:news.detail", "cases.review", Array(
	"IBLOCK_TYPE" => "edu",	// Тип информационного блока (используется только для проверки)
	"IBLOCK_ID" => "91",	// Код информационного блока
