...
class Version20250721185408 extends Version
{
    protected $description = "127814 | Выгрузить доработки на копию сайта | выгрузка ИБ Почему стоит пройти сертификацию у нас (зеленый блок)";
  ...
  'CODE' => 'pochemu-stoit-proyti-sertifikatsiyu-u-nas-zelen-bl',
  'API_CODE' => NULL,
  'NAME' => 'Почему стоит пройти сертификацию у нас (зеленый блок)',
  'ACTIVE' => 'Y',
  'SORT' => '26',
  'LIST_PAGE_URL' => '',
  'DETAIL_PAGE_URL' => '',
  ...
  array (
    ...
    'UF_BLOCK_TITLE' => 'Заголовок блока',
    'NAME' => 'Название',
    'CODE' => 'Символьный код',
    'PICTURE' => 'Изображение',
