...
class Version20251218160311 extends Version
{
    protected $description = "135531 | Главная / Добавить блок Чувствуете, что застряли…\" | ИБ";
  ...
  'CODE' => 'stackRole',
  'API_CODE' => 'stackRole',
  'NAME' => 'Чувствуете, что застряли в своей зарплате или роли?',
  'ACTIVE' => 'Y',
  'SORT' => '500',
  'LIST_PAGE_URL' => '#SITE_DIR#/edu_const/index.php?ID=#IBLOCK_ID#',
  'DETAIL_PAGE_URL' => '#SITE_DIR#/edu_const/detail.php?ID=#ELEMENT_ID#',
  'SECTION_PAGE_URL' => '#SITE_DIR#/edu_const/list.php?SECTION_ID=#SECTION_ID#',
  'PICTURE' => NULL,
  'DESCRIPTION' => '',
  ...
  array (
    ...
    'PROPERTY_BTN_NAME' => 'Название кнопки',
    'PROPERTY_BTN_LINK' => 'Ссылка кнопки',
