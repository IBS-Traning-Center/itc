...
class Version20250710110123 extends Version
{
    protected $description = "126973 | Доработка форм / Почтовые шаблоны формы Получить консультацию";
    ...
    public function up()
    {
        ...
        $helper->Event()->saveEventType('FORM_FILLING_get_expert_testing', array (
  'LID' => 'ua',
  'EVENT_TYPE' => 'email',
  'NAME' => 'Заповнена web-форма "get_expert_testing"',
...
#expert_testing# - Вид оценки
#expert_testing_RAW# - Вид оценки (оригінальне значення)
#name# - Как к вам обращаться
#name_RAW# - Как к вам обращаться (оригінальне значення)
#email# - Эл. почта
#email_RAW# - Эл. почта (оригінальне значення)
#phone# - Телефон
#phone_RAW# - Телефон (оригінальне значення)
#company# - Компания
#company_RAW# - Компания (оригінальне значення)
#question# - Ваш вопрос
#question_RAW# - Ваш вопрос (оригінальне значення)
#job# - Должность
...
',
  ...
  'LID' => 'ru',
  'EVENT_TYPE' => 'email',
  'NAME' => 'Заполнена web-форма "get_expert_testing"',
...
#expert_testing# - Вид оценки
#expert_testing_RAW# - Вид оценки (оригинальное значение)
#name# - Как к вам обращаться
#name_RAW# - Как к вам обращаться (оригинальное значение)
#email# - Эл. почта
...
#question# - Ваш вопрос
#question_RAW# - Ваш вопрос (оригинальное значение)
#job# - Должность
...
',
  'SORT' => '100',
            ...
            $helper->Event()->saveEventMessage('FORM_FILLING_get_expert_testing', array (
  'LID' => 
  array (
    0 => 'ru',
  ),
  ...
  'SUBJECT' => 'P#RS_RESULT_ID# Заявка на получение консультации',
  'MESSAGE' => '<div style="font-family:Arial,Helvetica,sans-serif;font-size:13px;">
	<p>
 <b>Заявка на получение консультации</b>
	</p>
<p>
 <b>Вид оценки:</b>#expert_testing#
	</p>
	<p>
 <b>Имя:</b> #name#
	</p>
 ...
 <br>',
  ...
  'LANGUAGE_ID' => 'ru',
  'EVENT_TYPE' => '[ FORM_FILLING_get_expert_testing ] Заполнена web-форма "get_expert_testing"',
));
            $helper->Event()->saveEventMessage('FORM_FILLING_get_expert_testing', array (
  'LID' => 
  array (
  ...
  'MESSAGE' => '<div style="font-family:Arial,Helvetica,sans-serif;font-size:13px;">
	...
	<p>
		 Спасибо за заявку на получение консультации
	</p>
	<p>
