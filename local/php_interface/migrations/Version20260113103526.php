...
class Version20260113103526 extends Version
{
    protected $description = "136421 | Главная / замена картинок в подразделе \"Область экспретизы\" | изменение разделов";
...
<div>Школы системного и бизнес-анализа в нашем каталоге тесно соприкасаются и органично дополняют друг друга. В разделе представлены курсы по системному анализу, сбору и анализу требований, моделированию бизнес-процесов, Business Inteligence и ВАВОК.</div>
 ...
 Александр – эксперт по управлению качеством ПО, управлению тестированием, анализу и совершенствованию инженерных процессов с опытом работы более 50 лет, эксперт ISTQB, RSTQB. Работает в компании Luxoft, где планирует и управляет тестированием в проектах, разрабатывает тестовые сценарии, проводит тестирование, аудит процессов тестирования и смежных процессов. С 2000 г. ведет тренинги в Luxoft Training, с 2006 г. – тренинг «Quality Assurance» университета Карнеги-Меллон, с 2011 г. – тренинги ISTQB.<br>',
  ...
  array (
    ...
    'UF_EXPERT' => NULL,
    'UF_H_TITLE' => NULL,
    'UF_SHOW_ON_MAIN_PAGE' => '0',
    'UF_MAIN_PAGE_IMAGE' => '16502',
  ),
  13 => 
  array (
  ...
  array (
    ...
    'CODE' => 'administrirovanie-_inux',
    'SORT' => '110',
    'ACTIVE' => 'Y',
    'XML_ID' => '',
    'DESCRIPTION' => 'В этом разделе вы познакомитесь с основными принципами и инструментами, необходимыми для эффективного управления системами на базе Linux.',
    'DESCRIPTION_TYPE' => 'html',
    'UF_META' => NULL,
    'UF_EXPERT' => NULL,
    'UF_H_TITLE' => NULL,
  ...
  array (
    ...
    'ACTIVE' => 'Y',
    'XML_ID' => '',
    'DESCRIPTION' => 'Раздел по обучению искусственного интеллекта (AI) предлагает пользователям возможность глубже понять основы и принципы работы AI-технологий.',
    'DESCRIPTION_TYPE' => 'text',
    'UF_META' => 'Раздел по обучению искусственного интеллекта (AI) предлагает пользователям возможность глубже понять основы и принципы работы AI-технологий.',
    'UF_EXPERT' => NULL,
    'UF_H_TITLE' => NULL,
    'UF_SHOW_ON_MAIN_PAGE' => '1',
    'UF_MAIN_PAGE_IMAGE' => '17311',
  ),
  19 => 
  array (
    'NAME' => 'Базы данных Oracle',
  ...
  array (
    ...
    'ACTIVE' => 'Y',
    'XML_ID' => '',
    'DESCRIPTION' => 'Авторизованные курсы Postgres Professional для администраторов баз данных PostgreSQL и разработчиков серверных приложений. Обучение рассчитано на ИТ-специалистов базового и продвинутого уровней. Все курсы состоят из нескольких модулей, каждый из которых включает теоретическую и практическую части. Материалы подготовлены экспертами Postgres Professional, курсы проводят сертифицированные преподаватели. После обучения слушатели могут получить статус сертифицированного специалиста по PostgreSQL, сдав экзамен. <br>
 <br>
<p>
 <a href="https://postgrespro.ru/" target="_blank"><img width="234" alt="PostgresPro_logo.png" src="/upload/medialibrary/e08/561moxum78vvnjrfdvjb0whvutpy9bnu/PostgresPro_logo.png" height="75" title="PostgresPro_logo.png" style="font-family: var(--ui-font-family-primary, var(--ui-font-family-helvetica));"></a><br>
</p>',
    'DESCRIPTION_TYPE' => 'html',
    'UF_META' => NULL,
    'UF_EXPERT' => NULL,
...
<p>
    ...
    'UF_H_TITLE' => NULL,
    'UF_SHOW_ON_MAIN_PAGE' => '1',
    'UF_MAIN_PAGE_IMAGE' => '17312',
  ),
  25 => 
  array (
    'NAME' => 'Инструменты управления Atlassian',
  ...
  array (
    ...
    'UF_SHOW_ON_MAIN_PAGE' => '0',
    'UF_MAIN_PAGE_IMAGE' => '16504',
  ),
  28 => 
  array (
    'NAME' => 'Разработка Golang',
    'CODE' => 'go_razrabotka',
    'SORT' => '200',
    'ACTIVE' => 'Y',
    'XML_ID' => '',
...
<p>
    ...
    'UF_H_TITLE' => NULL,
    'UF_SHOW_ON_MAIN_PAGE' => '1',
    'UF_MAIN_PAGE_IMAGE' => '17313',
  ),
  30 => 
  array (
    'NAME' => 'Разработка Java',
  ...
  array (
    ...
    'UF_SHOW_ON_MAIN_PAGE' => '0',
    'UF_MAIN_PAGE_IMAGE' => '16505',
  ),
  32 => 
  array (
    'NAME' => 'Разработка Python',
    'CODE' => 'python',
    'SORT' => '230',
    'ACTIVE' => 'Y',
    'XML_ID' => 'script',
    ...
    'UF_META' => 'Python',
    'UF_EXPERT' => NULL,
    'UF_H_TITLE' => 'Разработка ПО (Python)',
    'UF_SHOW_ON_MAIN_PAGE' => '0',
    'UF_MAIN_PAGE_IMAGE' => '15761',
  ),
  33 => 
  array (
    ...
    'UF_SHOW_ON_MAIN_PAGE' => '1',
    'UF_MAIN_PAGE_IMAGE' => '17315',
  ),
  34 => 
  array (
    'NAME' => 'Управления данными',
    ...
    'UF_H_TITLE' => NULL,
    'UF_SHOW_ON_MAIN_PAGE' => '1',
    'UF_MAIN_PAGE_IMAGE' => '17316',
  ),
  35 => 
  array (
    'NAME' => 'Управление внедрением ERP-систем',
...
инвестициям, корпоративному и транзакционному банкингу.',
  ...
  array (
    ...
    'ACTIVE' => 'Y',
    'XML_ID' => '',
    'DESCRIPTION' => '«Группа Астра» — один из лидеров российского рынка информационных технологий в области разработки программного обеспечения (ПО) и средств защиты информации.',
    'DESCRIPTION_TYPE' => 'text',
    'UF_META' => NULL,
    'UF_EXPERT' => NULL,
    'UF_H_TITLE' => NULL,
  ...
  40 => 
  array (
    'NAME' => 'Планета. Аналитика',
    'CODE' => 'planeta_analitika',
    'SORT' => '500',
    'ACTIVE' => 'Y',
    'XML_ID' => '',
    'DESCRIPTION' => '<span style="line-height: 2;">«Планета.» — это универсальная платформа, построенная на основе OLAP-технологий, позволяющая автоматизировать управленческие задачи планирования, бюджетирования, анализа, прогнозирования и формирования производственных программ.</span>',
    'DESCRIPTION_TYPE' => 'html',
    'UF_META' => NULL,
    'UF_EXPERT' => NULL,
    'UF_H_TITLE' => NULL,
  ...
  array (
    ...
    'ACTIVE' => 'N',
    'XML_ID' => '',
    'DESCRIPTION' => '<span style="line-height: 2;">Курсы по ESG научат вас интегрировать принципы устойчивого развития и социальной ответственности в ИТ-проекты. Вы узнаете, как технологии могут поддерживать устойчивость бизнеса и минимизировать риски.</span>',
    'DESCRIPTION_TYPE' => 'html',
    'UF_META' => NULL,
    'UF_EXPERT' => NULL,
    'UF_H_TITLE' => NULL,
  ...
  array (
    ...
    'ACTIVE' => 'Y',
    'XML_ID' => '',
    'DESCRIPTION' => 'TData — ведущий российский разработчик высокопроизводительных и безопасных решений для построения хранилищ данных, аналитики и автоматизации процессов по управлению данными с использованием искусственного интеллекта.',
    'DESCRIPTION_TYPE' => 'text',
    'UF_META' => NULL,
    'UF_EXPERT' => NULL,
    'UF_H_TITLE' => NULL,
