...
class Version20260115085429 extends Version
{
    protected $description = "136544 | Главная/ Форма ОС/ текст | изменение названия формы";
  ...
  'NAME' => 'Нужна помощь? Оставьте заявку, и мы свяжемся с вами в ближайшее время',
  'SID' => 'main_feedback',
  'BUTTON' => 'Отправить',
  'C_SORT' => '3000',
  'FIRST_SITE_ID' => NULL,
  ...
  array (
    'ACTIVE' => 'Y',
    'TITLE' => 'Согласен получать на e-mail информационные рассылки о новостях компании IBS Training',
    'TITLE_TYPE' => 'text',
    'SID' => 'info',
    'C_SORT' => '1000',
    'ADDITIONAL' => 'N',
