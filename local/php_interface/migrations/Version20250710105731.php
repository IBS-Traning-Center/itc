...
class Version20250710105731 extends Version
{
    protected $description = "126973 | Доработка форм / Почтовые события формы Обратной связи";
    ...
    public function up()
    {
        ...
        $helper->Event()->saveEventType('FORM_FILLING_main_feedback', array (
  'LID' => 'ua',
  'EVENT_TYPE' => 'email',
  'NAME' => 'Заповнена web-форма "main_feedback"',
...
',
  ...
  'LID' => 'ru',
  'EVENT_TYPE' => 'email',
  'NAME' => 'Заполнена web-форма "main_feedback"',
...
',
  'SORT' => '100',
            ...
            $helper->Event()->saveEventMessage('FORM_FILLING_main_feedback', array (
  'LID' => 
  array (
    0 => 'ru',
  ),
  ...
  'SUBJECT' => 'P#RS_RESULT_ID# Заявка. Форма обратной связи',
 ...
 <br>',
  ...
  'LANGUAGE_ID' => 'ru',
  'EVENT_TYPE' => '[ FORM_FILLING_main_feedback ] Заполнена web-форма "main_feedback"',
));
            $helper->Event()->saveEventMessage('FORM_FILLING_main_feedback', array (
  'LID' => 
  array (
  ...
  'MESSAGE' => '<div style="font-family:Arial,Helvetica,sans-serif;font-size:13px;">
	...
	<p>
		 Спасибо за оставленную заявку обратной связи
	</p>
<p>
