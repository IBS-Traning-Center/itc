...
class Version20250721185330 extends Version
{
    protected $description = "127814 | Выгрузить доработки на копию сайта | выгрузка ИБ Специалист на рынке труда";
  ...
  'CODE' => 'specialist',
  'API_CODE' => NULL,
  'NAME' => 'Специалист на рынке труда',
  'ACTIVE' => 'Y',
  'SORT' => '45',
  'LIST_PAGE_URL' => '',
  'DETAIL_PAGE_URL' => '',
