...
class Version20250721185918 extends Version
{
    protected $description = "127814 | Выгрузить доработки на копию сайта | выгрузка ИБ В основе сертификации специалиста";
  ...
  'CODE' => 'in_base_cert',
  'API_CODE' => NULL,
  'NAME' => 'В основе сертификации специалиста',
  'ACTIVE' => 'Y',
  'SORT' => '52',
  'LIST_PAGE_URL' => '',
  'DETAIL_PAGE_URL' => '',
