...
class Version20250721185905 extends Version
{
    protected $description = "127814 | Выгрузить доработки на копию сайта | выгрузка ИБ Для чего нужна сертификация";
  ...
  'CODE' => 'for_what',
  'API_CODE' => NULL,
  'NAME' => 'Для чего нужна сертификация',
  'ACTIVE' => 'Y',
  'SORT' => '53',
  'LIST_PAGE_URL' => '',
  'DETAIL_PAGE_URL' => '',
