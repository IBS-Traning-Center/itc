...
class Version20250721185710 extends Version
{
    protected $description = "127814 | Выгрузить доработки на копию сайта | выгрузка ИБ Какие задачи решают услуги по оценке..";
  ...
  'CODE' => 'testing_tasks',
  'API_CODE' => NULL,
  'NAME' => 'Какие задачи решают услуги по оценке..',
  'ACTIVE' => 'Y',
  'SORT' => '75',
  'LIST_PAGE_URL' => '',
  'DETAIL_PAGE_URL' => '',
