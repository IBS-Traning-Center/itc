...
class Version20250721191846 extends Version
{
    protected $description = "127814 | Выгрузить доработки на копию сайта | Форма 50";
  ...
  'NAME' => 'Получить материалы для подготовки к сертификации',
  'SID' => 'get_materials',
  'BUTTON' => 'Получить список тем',
  'C_SORT' => '3000',
  'FIRST_SITE_ID' => NULL,
  'IMAGE_ID' => NULL,
  'USE_CAPTCHA' => 'N',
  ...
  'SHOW_TEMPLATE' => NULL,
  'MAIL_EVENT_TYPE' => 'FORM_FILLING_get_materials',
  ...
  'arMENU' => 
  array (
    'ua' => 'Получить материалы для подготовки к сертификации',
    'ru' => 'Получить материалы для подготовки к сертификации',
  ),
  'arGROUP' => 
  array (
  ),
