...
class Version20250721191836 extends Version
{
    protected $description = "127814 | Выгрузить доработки на копию сайта | Форма 49 ";
  ...
  'NAME' => 'Получить консультацию или расчёт стоимости оценки персонала',
  'SID' => 'banner_get_consult',
  ...
  'SHOW_TEMPLATE' => NULL,
  'MAIL_EVENT_TYPE' => 'FORM_FILLING_banner_get_consult',
  ...
  'RESTRICT_STATUS' => '',
  'STAT_EVENT1' => 'form',
  'STAT_EVENT2' => 'banner_get_consult',
  'STAT_EVENT3' => '',
  'LID' => NULL,
  'C_FIELDS' => '0',
  'QUESTIONS' => '5',
  ...
  'arMENU' => 
  array (
    'ru' => 'Получить консультацию или расчёт стоимости оценки ',
    'ua' => 'Получить консультацию или расчёт стоимости оценки ',
  ),
  'arGROUP' => 
  array (
  ),
