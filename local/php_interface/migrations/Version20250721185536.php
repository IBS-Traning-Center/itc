...
class Version20250721185536 extends Version
{
    protected $description = "127814 | Выгрузить доработки на копию сайта | выгрузка ИБ Наши отличия от других УЦ и почему нас выбирают";
  ...
  'CODE' => 'our_differences',
  'API_CODE' => NULL,
  'NAME' => 'Наши отличия от других УЦ и почему нас выбирают',
  'ACTIVE' => 'Y',
  'SORT' => '60',
  'LIST_PAGE_URL' => '',
  'DETAIL_PAGE_URL' => '',
