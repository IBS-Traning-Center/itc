...
class Version20250710110414 extends Version
{
    protected $description = "126973 | Доработка форм / Форма Получить консультацию сертификатов";
  ...
  'SHOW_TEMPLATE' => NULL,
  'MAIL_EVENT_TYPE' => 'FORM_FILLING_get_consultation',
  ...
  array (
    'ACTIVE' => 'Y',
    'TITLE' => 'Направление сертификации',
    'TITLE_TYPE' => 'text',
    'SID' => 'cert_direction',
    'C_SORT' => '90',
    'ADDITIONAL' => 'N',
    ...
    array (
      0 => 
      array (
        'MESSAGE' => 'Направление сертификации',
        'VALUE' => 'dir',
        'FIELD_TYPE' => 'dropdown',
        'FIELD_WIDTH' => '0',
        'FIELD_HEIGHT' => '0',
