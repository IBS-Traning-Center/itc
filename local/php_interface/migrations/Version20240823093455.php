...
class Version20240823093455 extends Version
{
    protected $description = "112828 | Страница \"Корпоративное обучение\" | ИБ вопрос-ответ";
  ...
  'CODE' => 'questions',
  'API_CODE' => 'questions',
  'NAME' => 'УЦ Вопрос-ответ',
  'ACTIVE' => 'Y',
  'SORT' => '500',
  'LIST_PAGE_URL' => '#SITE_DIR#/edu/index.php?ID=#IBLOCK_ID#',
  'DETAIL_PAGE_URL' => '#SITE_DIR#/edu/detail.php?ID=#ELEMENT_ID#',
