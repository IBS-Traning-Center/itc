            ...
            <?if(count($arResult["ITEMS"]["AnDelCanBuy"]) > 0):?>
                ...
                <div class="cart-ordering">
                    <?if ($arParams["HIDE_COUPON"] != "Y"):?>
                        <div class="cart-code">
                            <input onclick="if (this.value=='<?=GetMessage("SALE_COUPON_VAL")?>')this.value=''" onblur="if (this.value=='')this.value='<?=GetMessage("SALE_COUPON_VAL")?>'" value="<?=GetMessage("SALE_COUPON_VAL")?>" name="COUPON">
                        </div>
                    <?endif;?>
